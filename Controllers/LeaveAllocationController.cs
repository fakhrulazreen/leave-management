...
namespace leave_management.Controllers
{
    ...
    public class LeaveAllocationController : Controller
    {
        ...
        public LeaveAllocationController(ILeaveAllocationRepository leaveallocationrepo, ILeaveTypeRepository leavetyperepo, IUnitOfWork unitOfWork, IMapper mapper, UserManager<Employee> userManager)
        {
        ...
        public async Task<ActionResult> Details(string id)
        {
            ...
            var leaveallocation = await _unitOfWork.LeaveAllocations.FindAll(
                    expression: q => q.EmployeeId == id,
                    includes: new List<string> { "LeaveType" }
                   ); //get leave allocation of employee
        ...
        public async Task<ActionResult> Edit(int id)
        {
            ...
            model.LeaveTypes = _mapper.Map<LeaveTypeVM>(await _unitOfWork.LeaveTypes.Find(q => q.Id == model.Id));
        ...
        public async Task<ActionResult> Edit(EditLeaveAllocationVM model)
        {
            try
            {
                ...
                async Task AddModelError(string propertyName)
                {
                    ...
                    var leaveType = await _unitOfWork.LeaveTypes.Find(q => q.Id == model.Id);
